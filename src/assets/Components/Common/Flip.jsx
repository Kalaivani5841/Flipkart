...
function Flip() {
  ...
  const searchSuggestions = ["Trendings", "Mobiles", "Laptops", "Shoes", "Watches", "Cameras","Headphones","Smartwatches","Air Conditioners","Refrigerators","Books","Beauty Products","Toys","Furniture"];
